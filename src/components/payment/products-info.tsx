...
import EstimatedDeliveryDate, { EstimatedDeliveryDateProps } from '@/components/payment/estimated-delivery-date'
...
const ProductItem = ({ className, image, name, tags, type, salePrice, price, quantity, nature }: ProductItemProps) => {
  return (
    <div className={cn('w-[54.4375rem] py-4 flex items-center border-b border-neutral-3', className)}>
      <div className='flex gap-4 items-start w-[27.9375rem]'>
...
type ProductsInfoProps = EstimatedDeliveryDateProps & {
  products: ProductItemProps[]
}

const ProductsInfo = ({ products, ...estimatedDeliveryDate }: ProductsInfoProps) => {
  return (
    <CardSection title='Thông tin kiện hàng'>
      <EstimatedDeliveryDate {...estimatedDeliveryDate} />
      <div className='w-[54.4375rem] rounded-t-lg bg-secondary-4 flex'>
        <div className='flex items-center px-4 py-5 gap-4 w-[27.9375rem] cursor-pointer'>
